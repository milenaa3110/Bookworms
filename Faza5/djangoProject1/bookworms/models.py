...
class Book(models.Model):
    ...
    coverImage = models.ImageField(upload_to='images/', default='images/closedBook.jpg')
...
class Reaction(models.Model):
    ...
    idReview = models.ForeignKey(Reviews, on_delete=models.CASCADE, db_column='idReview')
    idUser = models.ForeignKey(UsernamesPasswords, on_delete=models.CASCADE, db_column='idUser')
